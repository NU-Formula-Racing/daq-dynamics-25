...
void updateSignals(std::array<float, 8> airSpeed, std::array<float, 2> coolantTemperatures, std::array<float, 2> coolantFlowRate, std::array<float, 6> imu_data) {
   ...
   imu_acceleration_x_acceleration = imu_data[0];
   imu_acceleration_y_acceleration = imu_data[1];
   imu_acceleration_z_acceleration = imu_data[2];
   imu_gryo_x_angular_speed = imu_data[3];
   imu_gryo_y_angular_speed = imu_data[4];
   imu_gryo_z_angular_speed = imu_data[5];
