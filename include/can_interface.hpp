...
class CANInterface {
   ...
   private:
    ...
    MakeSignedCANSignal(float, 32, 16, 0.1, 0.0) coolant_temps_before_motor_temperature {};
    MakeSignedCANSignal(float, 48, 16, 0.1, 0.0) coolant_temps_before_accumulator_temperature {};

    MakeSignedCANSignal(float, 0, 16, 0.1, 0.0) imu_acceleration_x {};
    MakeSignedCANSignal(float, 16, 16, 0.1, 0.0) imu_acceleration_y {};
    MakeSignedCANSignal(float, 32, 16, 0.1, 0.0) imu_acceleration_z {};

    MakeSignedCANSignal(float, 0, 16, 0.1, 0.0) imu_gryo_x {};
    MakeSignedCANSignal(float, 16, 16, 0.1, 0.0) imu_gryo_y {};
    MakeSignedCANSignal(float, 32, 16, 0.1, 0.0) imu_gryo_z {};

    MakeSignedCANSignal(float, 0, 16, 0.1, 0.0) lower_air_speed_0 {};
    MakeSignedCANSignal(float, 16, 16, 0.1, 0.0) lower_air_speed_1 {};
    MakeSignedCANSignal(float, 32, 16, 0.1, 0.0) lower_air_speed_2 {};
    MakeSignedCANSignal(float, 48, 16, 0.1, 0.0) lower_air_speed_3 {};

    MakeSignedCANSignal(float, 0, 16, 0.1, 0.0) upper_air_speed_4 {};
    MakeSignedCANSignal(float, 16, 16, 0.1, 0.0) upper_air_speed_5 {};
